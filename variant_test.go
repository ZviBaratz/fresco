...
func TestShippedVariantsOps(t *testing.T) {
	...
	want := map[Variant]policy{
		...
		// glyph ramp's top two thirds (no measurable cell below glyph 4 of 11) and left
		// the density channel unable to show a knot; see ops for the sweep and the
		// confetti floor that stops it going lower.
